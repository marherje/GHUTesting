...
#include "../include/analysis_prob_polpos.h"
...
void DrawLeg()
{
  ...
  TLegend *leg2 = new TLegend(0.,0.375,1.3,0.725,"","blNDC");
  leg2->SetTextFont(42);
...
TH1F * histo_one_energy_unpol(std::vector<TH2F*> probhistos_c,std::vector<TH2F*> probhistos_b,double energy_under_test=250, TString errortype="Stat", TString tpc_status="default", TString polposstring="nompolpos")
{
  ...
  TH1F * results_unpol = new TH1F("AFB_"+energyst+"_"+errortype+"_unpol"+"_"+polposstring,"AFB_"+energyst+"_"+errortype+"_unpol"+"_"+polposstring,xyNBINS,xyedges);
...
TH1F * histo_one_energy(std::vector<TH2F*> probhistos_c,std::vector<TH2F*> probhistos_b,double energy_under_test=250, TString errortype="Stat", TString tpc_status="default", TString polposstring="nompolpos")

{
  ...
  const Int_t xyNBINS = 8;
  Double_t xyedges[xyNBINS + 1] = {-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5};
  TH1F * results = new TH1F("AFB_"+energyst+"_"+errortype+"_"+polposstring,"AFB_"+energyst+"_"+errortype+"_"+polposstring,xyNBINS,xyedges);
...
TH1F * histo_both_energies(std::vector<TH2F*> probhistos_c,std::vector<TH2F*> probhistos_c500,std::vector<TH2F*> probhistos_b,std::vector<TH2F*> probhistos_b500,TString errortype="Stat", TString tpc_status="default", TString polposstring="nompolpos")
{
    TString energyst="250&500_GeV";

    const Int_t xyNBINS = 8;
    Double_t xyedges[xyNBINS + 1] = {-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5};
    TH1F * results = new TH1F("AFB_both_"+energyst+"_"+errortype+"_"+polposstring,"AFB_both_"+energyst+"_"+errortype+"_"+polposstring,xyNBINS,xyedges);
...
TH1F * histo_three_energies(std::vector<TH2F*> probhistos_c,std::vector<TH2F*> probhistos_c500,std::vector<TH2F*> probhistos_c1000,std::vector<TH2F*> probhistos_b,std::vector<TH2F*> probhistos_b500,std::vector<TH2F*> probhistos_b1000,TString errortype="Stat", TString tpc_status="default", TString polposstring="nompolpos")
{
  TString energyst="250&500&1000 GeV";

  const Int_t xyNBINS = 8;
  Double_t xyedges[xyNBINS + 1] = {-0.5, 0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5};
  TH1F * results = new TH1F("AFB_three_"+energyst+"_"+errortype+"_"+polposstring,"AFB_three_"+energyst+"_"+errortype+"_"+polposstring,xyNBINS,xyedges);
  int binx;
  int biny;
  for(int j=1; j<theory.size(); j++) {
    biny=0;
...
void test_SM_polpos_masses()
{

  //Read all models:
  read_all_models(false);
  std::vector<observables_struct_t> observables_nopolpos=create_observables(0.0);
  std::vector<observables_struct_t> observables_nompolpos=create_observables(0.3);
  std::vector<observables_struct_t> observables_imppolpos=create_observables(0.6);
  std::vector<observables_struct_t> observablesnom=create_observables_nom();
  std::vector<TH2F*> probhistos_c_250_nopolpos=nsigmas_models(4,250, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_b_250_nopolpos=nsigmas_models(5,250, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_c_250_nompolpos=nsigmas_models(4,250, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_b_250_nompolpos=nsigmas_models(5,250, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_c_250_imppolpos=nsigmas_models(4,250, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  std::vector<TH2F*> probhistos_b_250_imppolpos=nsigmas_models(5,250, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  std::vector<TH2F*> probhistos_c_500_nopolpos=nsigmas_models(4,500, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_b_500_nopolpos=nsigmas_models(5,500, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_c_500_nompolpos=nsigmas_models(4,500, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_b_500_nompolpos=nsigmas_models(5,500, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_c_500_imppolpos=nsigmas_models(4,500, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  std::vector<TH2F*> probhistos_b_500_imppolpos=nsigmas_models(5,500, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  std::vector<TH2F*> probhistos_c_1000_nopolpos=nsigmas_models(4,1000, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_b_1000_nopolpos=nsigmas_models(5,1000, observables_nopolpos, observablesnom,"StatTheo250","dNdx","nopolpos");
  std::vector<TH2F*> probhistos_c_1000_nompolpos=nsigmas_models(4,1000, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_b_1000_nompolpos=nsigmas_models(5,1000, observables_nompolpos, observablesnom,"StatTheo250","dNdx","nompolpos");
  std::vector<TH2F*> probhistos_c_1000_imppolpos=nsigmas_models(4,1000, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  std::vector<TH2F*> probhistos_b_1000_imppolpos=nsigmas_models(5,1000, observables_imppolpos, observablesnom,"StatTheo250","dNdx","imppolpos");
  
  TH1F * results_250_unpol[3];
  results_250_unpol[0]=histo_one_energy_unpol(probhistos_c_250_nopolpos,probhistos_b_250_nopolpos,250,"StatTheo250","dNdx","nopolpos");
  results_250_unpol[1]=histo_one_energy_unpol(probhistos_c_250_nompolpos,probhistos_b_250_nompolpos,250,"StatTheo250","dNdx","nompolpos");
  results_250_unpol[2]=histo_one_energy_unpol(probhistos_c_250_imppolpos,probhistos_b_250_imppolpos,250,"StatTheo250","dNdx","imppolpos");
  
  TH1F * results_250[3];
  results_250[0]=histo_one_energy(probhistos_c_250_nopolpos,probhistos_b_250_nopolpos,250,"StatTheo250","dNdx","nopolpos");
  results_250[1]=histo_one_energy(probhistos_c_250_nompolpos,probhistos_b_250_nompolpos,250,"StatTheo250","dNdx","nompolpos");
  results_250[2]=histo_one_energy(probhistos_c_250_imppolpos,probhistos_b_250_imppolpos,250,"StatTheo250","dNdx","imppolpos");
  
  TH1F * results_both[3];
  results_both[0]=histo_both_energies(probhistos_c_250_nopolpos,probhistos_c_500_nopolpos,probhistos_b_250_nopolpos,probhistos_b_500_nopolpos,"StatTheo250","dNdx","nopolpos");
  results_both[1]=histo_both_energies(probhistos_c_250_nompolpos,probhistos_c_500_nompolpos,probhistos_b_250_nompolpos,probhistos_b_500_nompolpos,"StatTheo250","dNdx","nompolpos");
  results_both[2]=histo_both_energies(probhistos_c_250_imppolpos,probhistos_c_500_imppolpos,probhistos_b_250_imppolpos,probhistos_b_500_imppolpos,"StatTheo250","dNdx","imppolpos");
  
  TH1F * results_three[3];
  results_three[0]=histo_three_energies(probhistos_c_250_nopolpos,probhistos_c_500_nopolpos,probhistos_c_1000_nopolpos,probhistos_b_250_nopolpos,probhistos_b_500_nopolpos,probhistos_b_1000_nopolpos,"StatTheo250","dNdx","nopolpos");
				      results_three[1]=histo_three_energies(probhistos_c_250_nompolpos,probhistos_c_500_nompolpos,probhistos_c_1000_nompolpos,probhistos_b_250_nompolpos,probhistos_b_500_nompolpos,probhistos_b_1000_nompolpos,"StatTheo250","dNdx","nompolpos");
					results_three[2]=histo_three_energies(probhistos_c_250_imppolpos,probhistos_c_500_imppolpos,probhistos_c_1000_imppolpos,probhistos_b_250_imppolpos,probhistos_b_500_imppolpos,probhistos_b_1000_imppolpos,"StatTheo250","dNdx","imppolpos");
  ...
  //TString title_precision[]={"","","","0","30","60","0","30","60","0","30","60"};
  TString title_precision[]={"0","0","0","0","30","60","0","30","60","0","30","60"};
  ...
  padR->cd();
  DrawLeg();
  QQBARLabel3(0.05,0.155, "] e^{+} pol. (%) ",kBlack,0.17); //0.05,0.95
  //  QQBARLabel2(0.1,0.88, "#bullet N: 0 ",kBlack,0.16);
  //QQBARLabel2(0.1,0.81, "#bullet S: 30 ",kBlack,0.16);
  //QQBARLabel2(0.1,0.74, "#bullet I: 60 ",kBlack,0.16);
  ...
  for(int isave=0; isave<2 ;isave++){
      c_SM_comparison->SaveAs("SM_comparison_pos60_mZ1"+savingformat[isave]);
  }
}
